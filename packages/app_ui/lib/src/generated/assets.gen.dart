...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/Header_2.png
  AssetGenImage get header2 =>
      const AssetGenImage('assets/images/Header_2.png');

  /// File path: assets/images/Header_3.png
  AssetGenImage get header3 =>
      const AssetGenImage('assets/images/Header_3.png');
  ...
  /// List of all assets
  List<AssetGenImage> get values => [header1, header2, header3, product, logo];
}
...
class AssetGenImage {
  ...
  String get path => 'packages/app_ui/$_assetName';
